...
public:
    ...
    void setupUi(QDialog *ARX_Settings)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 163, 289));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 163, 289));
    ...
    void retranslateUi(QDialog *ARX_Settings)
    {
        ...
        label_11->setText(QCoreApplication::translate("ARX_Settings", "Odchylenie standardowe zak\305\202\303\263cenia", nullptr));
